...
pub use kb::{
    ...
    KbFilter, KbItem, KbUpdate, MediaPathParams, NamespacesErrorResponse, NewKb, OutputFormat,
    RandomErrorResponse, ReindexResult, ScoredKbItem, SemanticQuery, StoreMediaParams,
    build_metadata, file_extension, format_metadata, is_media_category, media_file_path,
    normalize_path, parse_metadata_input,
};
